...
function moreimageview() {
    ...
    e.css({
        left: "0px"
    }), e.load("http://ibn.adreach.co/ads-request?j=9&amp;i=183309745&amp;t=2&amp;s=I03002149467519449967&amp;a=http://demo.themeify.com/nunu1/moreImage/gallery1.html"), $(".moreImages").text("Close More Images"), $("figure.big .contentRight", ".scalediv").css({
        position: "fixed"
